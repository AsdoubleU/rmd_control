...
public:
  ...
  void WriteInnerGainP(const std_msgs::Float32ConstPtr &msg);
  void WriteInnerGainI(const std_msgs::Float32ConstPtr &msg);
  ...
  void SwitchGainCTCKP(const std_msgs::Float32MultiArrayConstPtr &msg);
  void SwitchGainCTCKV(const std_msgs::Float32MultiArrayConstPtr &msg);
  void FrictionKv(const std_msgs::Float32MultiArrayConstPtr &msg);
  ...
  void StartRecording(const std_msgs::BoolConstPtr &msg);
  void TestTorque(const std_msgs::Float32MultiArrayConstPtr &msg);
  
  void Pushedcallback(const std_msgs::BoolConstPtr &msg);
